...
define([
    ...
    function (liteolapVmTemplate, tableModel, chartModel) {
        ...
        return {
            ...
            class: 'liteolap', // 工具箱中 与 拖拽过程中 的class，样式表中通过外层来复用
            defaultWidth: 900,
            defaultHeight: 500,
            vm: {
